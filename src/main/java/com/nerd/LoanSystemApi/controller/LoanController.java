...
public class LoanController {
    ...
    public ResponseEntity<List<LoanResponseBody>> getAllLoansByUserIdAndSorted(
    ...
    public ResponseEntity<Void> createLoan(
            @PathVariable("userId") Integer userId,
            @Valid @RequestBody LoanRequestBody loanRequestBody)
    {
    ...
    private ResponseEntity<LoanResponseBody> getLoanById(
            @PathVariable("userId") Integer userId,
    ...
    public ResponseEntity<Void> deleteLoanById(
            @PathVariable("userId") Integer userId,
            @PathVariable("loanId") Integer loanId)
    {
